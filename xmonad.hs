...
import XMonad.Util.SpawnOnce
   ...
   -- ColorScheme module (SET ONLY ONE!)
      ...
      -- SolarizedLight
      -- TomorrowNight
import Colors.EverforestMD

myFont :: String
myFont = "xft:MesloLGS Nerd Font Mono:regular:size=1:antialias=true:hinting=true"
...
myFileManager = "thunar"       -- Sets thunar as favorite file manager
...
myStartupHook = do
  ...
  spawn "killall picom"   -- kill current conky on each restart
  spawn "killall trayer"  -- kill current trayer on each restart
  spawnOnce "xrandr --output Virtual-1 --primary --mode 1920x1080 --pos 0x0 --rotate normal" -- adding this in case of switching between xmobar and polybar.
  spawnOnce "sxhkd -c ~/.config/xmonad/sxhkd/sxhkdrc"
  spawnOnce "lxsession"
  ...
  spawn ("sleep 2 && trayer --edge top --margin 6 --distance 6 --align right --widthtype request --padding 10 --SetDockType true --SetPartialStrut true --expand true --transparent true --alpha 0 " ++ colorTrayer ++ " --height 32")

  -- Select only =ONE= of the following four ways to set the wallpaper.
  -- spawnOnce "xargs xwallpaper --stretch ~/.config/wezterm/wall/appa.jpg"
  spawnOnce "xargs xwallpaper --stretch ~/Pictures/yoda-everforest-01.jpg"
  -- spawnOnce "~/.fehbg &"  -- set last saved feh wallpaper
  -- spawnOnce "feh --randomize --bg-fill /usr/share/backgrounds/dtos-backgrounds/*"  -- feh set random wallpaper
  -- spawnOnce "nitrogen --restore &"   -- if you prefer nitrogen to feh
  setWMName "Xmonad-Boki"
...
myTabTheme = def { fontName            = myFont
                 ...
                 , inactiveTextColor   = color08
                 }

-- Theme for showWName which prints current workspace when you change workspaces.
myShowWNameTheme :: SWNConfig
myShowWNameTheme = def
  { swn_font              = "xft:MesloLGS Nerd Font Mono:bold:size=60"
  , swn_fade              = 1.0
  , swn_bgcolor           = "#1c1f24"
  , swn_color             = "#ffffff"
  }
...
-- myWorkspaces = [" 1 : <fn=2>\xf120</fn> ", " 2 : <fn=2>\xf269</fn> ", " 3 : <fn=2>\xf04b</fn> ", " 4 : <fn=2>\xf09b</fn> ", " 5 : <fn=2>\xf03d</fn> ", " 6 : <fn=2>\xf1e3</fn> ", " 7 : <fn=2>\xf07b</fn> ", " 8 : <fn=2>\xf21b</fn> ", " 9 : <fn=2>\xf21e</fn> "]
myWorkspaces = [" <fn=1>\xf120</fn> ", " <fn=1>\xf269</fn> ", " <fn=1>\xf04b</fn> ", " <fn=1>\xf09b</fn> ", " <fn=1>\xf03d</fn>  ", " <fn=1>\xf1e3</fn> ", " <fn=1>\xf07b</fn> ", " <fn=1>\xf21b</fn> ", " <fn=1>\xf21e</fn> "]
...
showKeybindings x = addName "Show Keybindings" $ io $ do
  h <- spawnPipe $ "yad --text-info --fontname=\"MesloLGS Nerd Font Mono 12\" --fore=#46d9ff back=#282c36 --center --geometry=1200x800 --title \"XMonad keybindings\""
...
myKeys c =
  ...
  -- , ("M-S-d", addName "Run prompt"      $ sequence_ [spawn (mySoundPlayer ++ dmenuSound), spawn "~/.local/bin/dm-run"`1`
  , ("M-S-d", addName "Run prompt"      $ spawn "~/.local/bin/dm-run")
-- <<<<<<< HEAD
...
-- >>>>>>> 46223b7f1772cc858e968592611dbfca23f99e85
  ...
  [ ("M-<Return>", addName "Launch ghostty"   $ spawn "ghostty")
  , ("M-S-w", addName "Launch wezterm"   $ spawn "wezterm")
  , ("M-e", addName "Launch myEditor"   $ spawn (myEditor))
  , ("C-t", addName "Launch myTerminal"   $ spawn (myTerminal))
  , ("M-f", addName "Launch web browser"       $ spawn (myBrowser))
  , ("M-S-<Return>", addName "Launch myFileManager"  $spawn (myFileManager))
  ...
  [ ("M-b", addName "Toggle float layout"        $ sendMessage (T.Toggle "floats"))
...
main = do
  ...
  xmonad $ addDescrKeys' ((mod4Mask, xK_F2), showKeybindings) myKeys $ ewmh $ docks $ def
    ...
    , logHook = dynamicLogWithPP $  filterOutWsPP [scratchpadWorkspaceTag] $ xmobarPP
        ...
        , ppTitle = xmobarColor color08 "" . shorten 50
          -- Separator character
